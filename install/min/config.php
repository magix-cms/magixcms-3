...
$minarraydir = array('install'.DIRECTORY_SEPARATOR.'min');
 ...
 */
$min_cachePath = $minpath.DIRECTORY_SEPARATOR.'install'.DIRECTORY_SEPARATOR.'caching'.DIRECTORY_SEPARATOR.'minify';
