...
<body style="word-spacing:normal;background-color:{$body_color};">
  <div style="background-color:{$body_color};">
    <!--[if mso | IE]><table align="center" border="0" cellpadding="0" cellspacing="0" class="" role="presentation" style="width:600px;" width="600" bgcolor="{$body_color}" ><tr><td style="line-height:0px;font-size:0px;mso-line-height-rule:exactly;"><![endif]-->
    <div style="background:{$body_color};background-color:{$body_color};margin:0px auto;max-width:600px;">
    ...
    <div class="body-section" style="-webkit-box-shadow: 1px 4px 11px 0px rgba(0, 0, 0, 0.15); -moz-box-shadow: 1px 4px 11px 0px rgba(0, 0, 0, 0.15); box-shadow: 1px 4px 11px 0px rgba(0, 0, 0, 0.15); background: #ffffff; background-color: #ffffff; margin: 0px auto; max-width: 600px;">
                            ...
                            <tbody>
                              <tr>
                                <td align="left" style="font-size:0px;padding:10px 25px;padding-bottom:0;word-break:break-word;">
                                  <div style="font-family:Roboto, 'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:16px;font-weight:bold;line-height:23px;text-align:left;color:#333333;">{#object_mail#|ucfirst}&nbsp;: {$data.title}</div>
      ...
      <p style="border-top:solid 2px {$main_color};font-size:1px;margin:0px auto;width:100%;">
      </p>
      
      <!--[if mso | IE]><table align="center" border="0" cellpadding="0" cellspacing="0" style="border-top:solid 2px {$main_color};font-size:1px;margin:0px auto;width:550px;" role="presentation" width="550px" ><tr><td style="height:0;line-height:0;"> &nbsp;
</td></tr></table><![endif]-->
      ...
      <div style="font-family:Roboto, 'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:12px;font-weight:bold;line-height:23px;text-align:left;text-transform:uppercase;color:#333333;">{#mail_from#|ucfirst}</div>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" role="presentation" style width="100%">
                                <tr>
                                    <td align="center" style="font-size:0px;padding:0;word-break:break-word;">
                                        ...
                                        {if isset($companyData['socials']['facebook'])}
                                        <!--[if mso | IE]><td><![endif]-->
                                        ...
                                        <!--[if mso | IE]></td><![endif]-->
                                        {/if}
                                        {if isset($companyData['socials']['twitter'])}
                                        <!--[if mso | IE]><td><![endif]-->
                                        <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="float:none;display:inline-table;">
                                            <tr>
                                                <td style="padding:4px;">
                                        ...
                                        <!--[if mso | IE]></td><![endif]-->
                                        {/if}
                                        {if isset($companyData['socials']['linkedin'])}
                                        <!--[if mso | IE]><td><![endif]-->
                                        <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="float:none;display:inline-table;">
                                            <tr>
                                                <td style="padding:4px;">
                                        ...
                                        <!--[if mso | IE]></td><![endif]-->
                                        {/if}
                                        {if isset($companyData['socials']['pinterest'])}
                                        <!--[if mso | IE]><td><![endif]-->
                                        <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="float:none;display:inline-table;">
                                            <tr>
                                                <td style="padding:4px;">
                                        ...
                                        <!--[if mso | IE]></td><![endif]-->
                                        {/if}
                                        {if isset($companyData['socials']['instagram'])}
                                        <!--[if mso | IE]><td><![endif]-->
                                        <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="float:none;display:inline-table;">
                                            <tr>
                                                <td style="padding:4px;">
                                        ...
                                        <!--[if mso | IE]></td><![endif]-->
                                        {/if}
                                        {if isset($companyData['socials']['github'])}
                                        <!--[if mso | IE]><td><![endif]-->
                                        <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="float:none;display:inline-table;">
                                            <tr>
                                                <td style="padding:4px;">
                                        ...
                                        <!--[if mso | IE]></td><![endif]-->
                                        {/if}
                                        {if isset($companyData['socials']['soundcloud'])}
                                        <!--[if mso | IE]><td><![endif]-->
                                        <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="float:none;display:inline-table;">
                                            <tr>
                                                <td style="padding:4px;">
