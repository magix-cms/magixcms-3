...
<div class="row">
    <form id="edit_page" action="{$smarty.server.SCRIPT_NAME}?controller={$smarty.get.controller}&amp;tabs=content&amp;action=edit" method="post" class="validate_form edit_form col-ph-12 col-md-10">
        <div class="row">
            <div class="col-ph-12">
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="content[{$id}][content_page]" id="content[{$id}][content_page]"
                                                  class="form-control mceEditor"
                                                  data-controller="{$smarty.get.controller}"
                                                  data-itemid="1"
                                                  data-lang="{$id}"
                                                  data-field="content_page">{call name=cleantextarea field=$pages.content[{$id}].content_page}</textarea>
                                    </div>
                                </div>
                            </div>
                        </fieldset>
