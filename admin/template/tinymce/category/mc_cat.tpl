...
{block name="head:title"}Search Categories{/block}
{block name="head:script"}<script type="text/javascript" src="/{baseadmin}/template/tinymce/category/mc_cat.js"></script>{/block}
            ...
            <form action="#" class="col-ph-12 col-md-6 col-lg-4 validate_form">
                ...
                <div class="tab-content">
                    ...
                    <fieldset role="tabpanel" class="tab-pane{if $iso@first} active{/if}" id="page-lang-{$id}">
                        ...
                        <div class="form-group">
                            <div id="{$iso}cat" class="btn-group btn-block selectpicker" data-clear="true" data-live="true">
                                ...
                                <div class="dropdown-menu">
                                    <div class="live-filtering" data-clear="true" data-autocomplete="true" data-keys="true">
                                        <label class="sr-only" for="input-cat">Rechercher dans la liste</label>
                                        <div class="search-box">
                                            <div class="input-group">
													<span class="input-group-addon" id="search-cat">
														<span class="fa fa-search"></span>
														<a href="#" class="fa fa-times hide filter-clear"><span class="sr-only">Effacer filtre</span></a>
													</span>
                                                <input type="text" placeholder="Rechercher dans la liste" id="input-cat" class="form-control live-search" aria-describedby="search-cat" tabindex="1" />
                                            </div>
                                        </div>
                                        <div id="filter-cat" class="list-to-filter tree-display">
                                            <ul class="list-unstyled">
                                            {include file="tinymce/loop/link-list.tpl" data=$cats[$id] type='cat'}
                                            </ul>
                            ...
                            <input type="hidden" name="{$iso}cat_id" id="{$iso}cat_id" class="form-control cat_id" value="" data-lang="{$iso}"/>
                        </div>
                    </fieldset>
                    {/foreach}
                </div>
            </form>
            <form id="cat-link" action="#" method="post" class="col-ph-12 col-md-6 col-lg-4 validate_form collapse">
                <div class="form-group">
