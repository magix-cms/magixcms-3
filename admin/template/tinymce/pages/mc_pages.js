...
+function($, baseadmin, undefined) {
    'use strict';
    var mc_pages = (function($, baseadmin, undefined){
                ...
                $('.pages_id').each(function(){
                    $(this).on('change', function(){
                        ...
                        if(typeof id !== 'undefined' && id !== '') {
                            $.jmRequest({
                                type: 'ajax',
                                url: '/'+baseadmin+'/index.php?controller=pages&action=getLink&id='+id+'&iso='+iso,
                                method: 'get',
                                success: function(d){
                                    if(typeof d === "object") {
                                        $('#pages-link').collapse('show');
                                        $('#text').val(d.name);
                                        $('#title').val(d.name);
                                        $('#url').val(d.url);
                                    }
