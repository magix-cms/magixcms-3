...
{block name="head:script"}<script type="text/javascript" src="/{baseadmin}/template/tinymce/pages/mc_pages.js"></script>{/block}
                ...
                <div class="tab-content">
                    {foreach $langs as $id => $iso}
                        <fieldset role="tabpanel" class="tab-pane{if $iso@first} active{/if}" id="page-lang-{$id}">
                            ...
                            <div class="form-group">
                                <div id="{$iso}pages" class="btn-group btn-block selectpicker" data-clear="true" data-live="true">
                                ...
                                <input type="hidden" name="{$iso}pages_id" id="{$iso}pages_id" class="form-control pages_id" value="" data-lang="{$iso}"/>
                            </div>
                        </fieldset>
                    {/foreach}
                </div>
            </form>
            <form id="pages-link" action="#" method="post" class="col-ph-12 col-md-6 col-lg-4 validate_form collapse">
                <div class="form-group">
