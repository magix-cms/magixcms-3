...
+function($, baseadmin, undefined) {
    'use strict';
    var mc_news = (function($, baseadmin, undefined){
                ...
                $('.news_id').each(function(){
                    $(this).on('change', function(){
                        ...
                        if(typeof id !== 'undefined' && id !== '') {
                            $.jmRequest({
                                type: 'ajax',
                                url: '/'+baseadmin+'/index.php?controller=news&action=getLink&id='+id+'&iso='+iso,
                                method: 'get',
                                success: function(d){
                                    if(typeof d === "object") {
                                        $('#news-link').collapse('show');
                                        $('#text').val(d.name);
                                        $('#title').val(d.name);
                                        $('#url').val(d.url);
                                    }
    ...
    $(function(){
        ...
        /*var data = {
            ...
            "category": mc_news.translate('category'),
