    ...
    <div class="panels row">
        <section class="panel col-ph-12 col-md-12">
            ...
            <div class="panel-body panel-body-form">
                ...
                <div class="row">
                    <form id="edit_pages_img" action="{$smarty.server.SCRIPT_NAME}?controller={$smarty.get.controller}&amp;action=edit&edit={$img.id_pages}&editimg={$img.id_img}" method="post" class="validate_form add_form col-ph-12 col-sm-6 col-md-4">
                        ...
                        <img src="/upload/pages/{$img.id_pages}/m_{$img.name_img}" class="img-responsive" />
    ...
    <script type="text/javascript">
        ...
        $(function(){
            if (typeof globalForm == "undefined")
            {
                ...
                var controller = "{$smarty.server.SCRIPT_NAME}?controller={$smarty.get.controller}&action=edit&edit={$img.id_pages}";
