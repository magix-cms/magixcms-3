<div class="row">
    {*<form id="edit_img_pages" action="{$smarty.server.SCRIPT_NAME}?controller={$smarty.get.controller}&amp;action=edit&edit={$page.id_pages}" method="post" enctype="multipart/form-data" class="validate_form edit_form_img col-ph-12">
    ...
    <form id="delete_img_pages" action="{$smarty.server.SCRIPT_NAME}?controller={$smarty.get.controller}&amp;action=delete" method="post" class="validate_form delete_form_img col-ph-12">
        <div class="form-group">
            <input type="hidden" id="del_img" name="del_img" value="{$page.id_pages}">
    ...
    {/foreach}
    <form id="edit_img_pages" action="{$smarty.server.SCRIPT_NAME}?controller={$smarty.get.controller}&amp;action=edit&amp;edit={$page.id_pages}" method="post" class="validate_form edit_form_img col-ph-12 col-md-6 col-lg-5">
        ...
        <div id="drop-zone" class="img-drop{if !isset($page.imgSrc) || empty($page.imgSrc)} no-img{/if}">
            ...
            <div class="preview-img">
                <img id="preview"
                     src="{if isset($page.imgSrc) && !empty($page.imgSrc)}/upload/pages/{$page.id_pages}/{$page.imgSrc['original'].img}{else}#{/if}"
        ...
        <fieldset>
            ...
            {if $edit}
                <input type="hidden" name="page[id]" value="{$page.id_pages}" />
            {/if}
