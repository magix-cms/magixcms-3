...
{block name='article:header'}
    ...
    <div class="pull-right">
        <p class="text-right">
            {#nbr_language#|ucfirst}: {$langs|count}<a href="{$smarty.server.SCRIPT_NAME}?controller={$smarty.get.controller}&amp;action=add" title="Ajouter un employé" class="btn btn-link">
