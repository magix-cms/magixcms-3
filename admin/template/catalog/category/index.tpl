...
{block name='article:header'}
    ...
    <div class="pull-right">
        <p class="text-right">
            {#nbr_category#|ucfirst}: {if !empty($pages)}{$pages|count}{else}0{/if}<a href="{$smarty.server.SCRIPT_NAME}?controller={$smarty.get.controller}&amp;action=add" title="{#add_cat#}" class="btn btn-link">
    ...
    <div class="panels row">
        <section class="panel col-ph-12">
            ...
            <div class="panel-body panel-body-form">
                ...
                {include file="section/form/table-form-3.tpl" data=$pages idcolumn='id_cat' activation=true sortable=$sortable controller="category" change_offset=true}
            </div>
        </section>
    </div>
