...
{block name='head:title'}{#add_category#|ucfirst}{/block}
        ...
        <div class="panels row">
            <section class="panel col-ph-12">
                ...
                <header class="panel-header">
                    <h2 class="panel-heading h5">{#add_category#|ucfirst}</h2>
                </header>
                <div class="panel-body panel-body-form">
                    <div class="mc-message-container clearfix">
                        <div class="mc-message"></div>
                    </div>
                    {include file="catalog/category/form/add.tpl" controller="category"}
                </div>
            </section>
        </div>
    {/if}
