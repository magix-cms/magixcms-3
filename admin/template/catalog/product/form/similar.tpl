<div class="row">
    <form id="edit_product_similar" action="{$smarty.server.SCRIPT_NAME}?controller={$smarty.get.controller}&amp;action=edit&edit={$page.id_product}" method="post" class="validate_form edit_form col-xs-12 col-md-6">
        <div class="row">
            <div class="col-xs-12 col-md-2">
                <div class="form-group">
                    <label for="id_product_2">{#id#|ucfirst} {#product#}&nbsp;</label>
