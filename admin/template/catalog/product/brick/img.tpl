<form id="table-image" action="">
    ...
    <div class="actions">
        <div class="pull-right">
            ...
            <button class="btn btn-lg btn-default update-checkbox" value="check-all" data-table="table-image">
                <span class="fa fa-check-square"></span> <span class="hidden-sm hidden-md">Sélectionner toutes les images</span>
            </button>
            <button class="btn btn-lg btn-default update-checkbox" value="uncheck-all" data-table="table-image">
