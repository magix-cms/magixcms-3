...
{block name='article:header'}
    ...
    <div class="pull-right">
        <p class="text-right">
            {#nbr_employee#|ucfirst}: {$getItemsEmployee|count}<a href="{$smarty.server.SCRIPT_NAME}?controller={$smarty.get.controller}&amp;action=add" title="Ajouter un employé" class="btn btn-link">
    ...
    <div class="panels row">
        <section class="panel col-xs-12">
            ...
            <div class="panel-body">
                ...
                {include file="section/form/table-form.tpl" data=$getItemsEmployee activation=true controller="employee"}
            </div>
        </section>
    </div>
