<div class="row">
    <form id="edit_snippet" action="{$smarty.server.SCRIPT_NAME}?controller={$smarty.get.controller}&amp;action=edit&edit={$page.id_snippet}" method="post" class="validate_form edit_form col-ph-12 col-lg-8">
        <div class="row">
