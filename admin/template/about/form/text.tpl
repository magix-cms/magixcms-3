                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="content[{$id}][company_content]" id="content[{$id}][company_content]" class="form-control mceEditor">{cleanTextarea field=$contentData.{$id}.content}</textarea>
                                    </div>
                                </div>
                            </div>
                        </fieldset>
