...
<div class="row">
<form id="add_pages" action="{$smarty.server.SCRIPT_NAME}?controller={$smarty.get.controller}&amp;action=addpage&amp;tab=page" method="post" class="validate_form col-ph-12 col-md-10 col-xs-8 add_form collapse in">
        ...
        <div class="row">
            ...
            <div class="col-ph-12 col-sm-4">
                <div class="form-group">
                    ...
                    <input id="menu_pages" data-toggle="toggle" type="checkbox" name="menu_pages" data-on="{#visible#}" data-off="{#hidden_f#}" data-onstyle="success" data-offstyle="danger" checked>
                </div>
            </div>
        </div>
