...
tinymce.PluginManager.add('mc_news', function(editor, url) {
    function showDialog() {
        ...
        //var i18Tab = [i18.translate('mc_news Title'),i18.translate('search')];
        win = editor.windowManager.open({
            title: "mc_news Title",
            file: tinyMCE.baseURL + '/plugins/mc_news/news.php',
            width: 800,
            height: 550,
            inline: 1,
            resizable: true,
    ...
    editor.addButton('mc_news', {
        //text: 'mc_news',
        icon: 'fa far fa-newspaper',
