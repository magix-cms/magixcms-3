...
$filemanagerArrayDir = array(PATHADMIN.DIRECTORY_SEPARATOR.'template'.DIRECTORY_SEPARATOR.'js'.DIRECTORY_SEPARATOR.'vendor'.DIRECTORY_SEPARATOR.'tiny_mce.'.VERSION_EDITOR.DIRECTORY_SEPARATOR.'plugins'.DIRECTORY_SEPARATOR.'mc_news');
