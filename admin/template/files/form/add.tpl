            ...
            <div class="row">
                <div class="col-xs-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control required" name="width_img" id="width_img" placeholder="{#ph_width#|ucfirst}" required>
                    </div>
                </div>
                <div class="col-xs-6">
                    <div class="form-group">
                        <label for="height_img">{#height#|ucfirst}</label>
                        <input type="text" class="form-control required" name="height_img" id="height_img" placeholder="{#ph_height#|ucfirst}" required>
                    </div>
                </div>
            </div>
            <div class="row">
