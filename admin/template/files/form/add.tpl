        ...
        <div class="col-ph-12 col-md-12">
            <div class="row">
                ...
                <div class="col-xs-6">
                    <div class="form-group">
                        <label for="module_img">{#module#|ucfirst}</label>
                        <input type="text" class="form-control required" name="imageConfig[module_img]" id="module_img" placeholder="{#ph_module#|ucfirst}" required>
                    </div>
                </div>
                <div class="col-xs-6">
                    <div class="form-group">
                        <label for="attribute_img">{#attribute#|ucfirst}</label>
                        <input type="text" class="form-control required" name="imageConfig[attribute_img]" id="attribute_img" placeholder="{#ph_attribute#|ucfirst}" required>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-xs-6">
                    ...
                    <div class="form-group">
                        <label for="type_img">{#type#|ucfirst}</label>
                        <input type="text" class="form-control required" name="imageConfig[type_img]" id="type_img" placeholder="{#ph_type#|ucfirst}" required>
                    </div>
                </div>
                <div class="col-xs-6">
                    <div class="form-group">
                        <label for="prefix_img">{#prefix#|ucfirst}</label>
                        <input type="text" class="form-control required" name="imageConfig[prefix_img]" id="prefix_img" placeholder="{#ph_prefix#|ucfirst}" required>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-xs-4">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control required" name="imageConfig[width_img]" id="width_img" placeholder="{#ph_width#|ucfirst}" required>
                    </div>
                </div>
                <div class="col-xs-4">
                    <div class="form-group">
                        <label for="height_img">{#height#|ucfirst}</label>
                        <input type="number" class="form-control required" name="imageConfig[height_img]" id="height_img" placeholder="{#ph_height#|ucfirst}" required>
                    </div>
                </div>
                <div class="col-xs-4">
                    <div class="form-group">
